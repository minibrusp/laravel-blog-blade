...
<article class="min-h-screen tracking-wider text-left mx-8">
  ...
  <div class="max-w-2xl px-4 my-8">
    <div class="">
      <h1 class="text-4xl font-light tracking-widest font-heading">Create a New Post</h1>
      <p class="font-light italic">Fill and submit this form to create a post</p>
    </div>
  </div>
  ...
  <form class="w-full max-w-lg" method="POST">
    ...
    <div class="flex flex-wrap -mx-3 mb-6">
      <div class="w-full px-3">
        ...
        <input class="appearance-none block w-full bg-white text-black font-light border border-black rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white focus:border-gray-500" id="title" type="text" name="title" placeholder="Enter Post Title" required>
    ...
    <div class="flex flex-wrap -mx-3 mb-6">
      <div class="w-full px-3">
        ...
        <textarea class=" no-resize appearance-none block w-full bg-white text-black font-light border border-black rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white focus:border-gray-500 h-48 resize-none" id="body" name="body" placeholder="Enter Post Body" required></textarea>
